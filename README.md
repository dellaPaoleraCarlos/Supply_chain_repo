...
Limpieza y Transformación (Wrangling): * Se realizó una limpieza profunda utilizando Python/SQL (según lo que prefieras destacar).

Tratamiento de valores nulos y normalización de nombres de puertos.
